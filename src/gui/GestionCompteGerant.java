...
public class GestionCompteGerant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel9);
        jLabel9.setBounds(10, 160, 34, 14);
        ...
        jTF_password.setBounds(110, 190, 100, 20);
        jPanel4.add(jTF_nom);
        ...
        jTF_login.setBounds(110, 160, 100, 20);
...
//        pack();
    ...
    private void jB_ajouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_ajouterActionPerformed
     ...
     User gerant = new User (WIDTH,jTF_nom.getText() , jTF_prenom.getText(), jTF_telephone.getText(), jTF_email.getText(), null, jTF_login.getText(), jTF_password.getText(),"gerant");
      GerantDAO gerantDAO= GerantDAO.getInstance();
